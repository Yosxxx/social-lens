      ...
      <div>
        <div className="flex flex-col gap-2">
          ...
          <div className="text-muted-foreground text-base">
            Export your instagram data in JSON, locate the required files, and
            analyze followers locally-no server uploads
          </div>
          <div className="bg-muted/40 p-3 rounded-md border-l-10 text-sm">
            <div className="flex items-center">
              <ShieldCheck className="mr-2" />
              All parsing runs in your browser. You retain full control of your
              data.
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-x-2 mt-2">
            <div className="bg-muted/40 rounded-full w-6 h-6 flex items-center justify-center font-bold text-sm">
              1
            </div>
            <div className="flex flex-col">
              ...
              <div className="text-muted-foreground text-sm flex gap-2 items-center flex-wrap">
                Open Instagram (app or web) <ArrowRight size={14} /> profile{" "}
                <ArrowRight size={14} /> menu <ArrowRight size={14} /> settings
              </div>
              <div className="text-muted-foreground text-sm flex gap-x-1 items-center">
                <InfoIcon size={14} /> Ensure you&apos;re on the correct account
                to access privacy/data tools.
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-x-2">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-muted-foreground text-sm flex gap-2 items-center">
                The data download tool may also appear under ‘Privacy and
                Security’.
              </div>
              <div className="text-muted-foreground text-sm flex gap-x-1 items-center">
                <InfoIcon size={14} /> Labels vary by region/app version; the
                goal is the export tool.
              </div>
            </div>
          </div>
          {/* Step 3 */}
          <div className="flex gap-x-2">
            ...
            <div className="flex flex-col">
              <div className="font-medium flex items-center gap-2">
                Request the Export in JSON
              </div>
              <div className="text-muted-foreground text-sm">
                Pick JSON and include Connections (followers/following).
              </div>
              <div className="text-muted-foreground text-sm flex gap-x-1 items-center">
                <InfoIcon size={14} /> You need <code>followers_1.json</code>{" "}
                and <code>following.json</code> for analysis.
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-x-2">
            ...
            <div className="flex flex-col">
              <div className="font-medium flex items-center gap-2">
                Verify Identity and Wait for Email
              </div>
              <div className="text-muted-foreground text-sm">
                Instagram sends a download link (expires). Typical wait: 24–48h.
              </div>
              <div className="text-muted-foreground text-sm flex gap-x-1 items-center">
                <InfoIcon size={14} /> Large accounts take longer; download
                promptly after the email.
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-x-2">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-muted-foreground text-sm flex gap-x-1 items-center">
                <InfoIcon size={14} /> Confirm <code>followers_1.json</code> and{" "}
                <code>following.json</code> exist; otherwise re-request with
                Connections.
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-x-2">
            ...
            <div className="flex flex-col">
              <div className="font-medium flex items-center gap-2">
                Upload to Profile Insight
              </div>
              <div className="text-muted-foreground text-sm">
                Open Upload and drop the ZIP. Processing is local.
              </div>
              <div className="text-muted-foreground text-sm flex gap-x-1 items-center">
                <InfoIcon size={14} /> We compute mutuals/asymmetries
