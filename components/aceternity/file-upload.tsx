...
export const FileUpload = ({ files = [], onChange }: { files?: File[]; onChange?: (files: File[]) => void }) => {
    ...
    return (
        <div className='w-full' {...getRootProps()}>
            <input {...getInputProps()} /> {/* Dropzone handles the input now */}
            <motion.div
                whileHover='animate'
                    ...
                    <div className='relative w-full mt-10 max-w-xl mx-auto'>
                        ...
                        {!files.length && (
                            <motion.div
                                ...
                                className={cn(
                                    'relative group-hover/file:shadow-2xl z-40 bg-zinc-800 dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md',
